          ...
          <>
            <div className={styles.smallScreen}>
              ...
              <div className={styles.bookActions}>
                <Link to={`/edit-book/${selectedBook.id}`} className={styles.editLink}>
                  Edit
                </Link>
                <button onClick={handleRemoveBook} className={styles.removeButton}>
                  Remove
                </button>
              </div>
            </div>
            <div className={styles.selectedBookSection}>
              ...
              <div>
                ...
                <p className={styles.bookAuthors}>
                  by {selectedBook.data.authors.map((a: { name: string }) => a.name).join(', ')}
                </p>
                <div>
