...
function Profile() {
    ...
    const { id: userId, email, username, avatarType, avatarImage, avatarColor, isPublic } = useSelector((state: RootState) => state.user);
    ...
    const handleSaveProfile = async () => {
        ...
        try {
            ...
            await updateUserProfile(userId, profileData, username || null);
    ...
    const renderAvatar = () => {
        return (
            <img
                src={`/img/profile/${avatarData.image}`}
                alt="Profile"
