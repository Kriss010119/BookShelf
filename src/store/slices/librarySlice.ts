...
import type { LibraryState } from "../../types/types.ts";
...
export const librarySlice = createSlice({
    ...
    reducers: {
        ...
        setPublicLibrary: (state, action: PayloadAction<{ library: { shelves: ShelfType[]; books: BookType[] }, ownerInfo: any }>) => {
...
export const { addShelf, removeShelf, addBook, removeBook, updateShelf, setLibrary, selectBook, clearSelectedBook, updateBook, setPublicLibrary } = librarySlice.actions;
